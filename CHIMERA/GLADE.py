#
#   This module handles GLADE and GLADE+ galaxy catalogs.
#   Adapted from DarkSirensStat <https://github.com/CosmoStatGW/DarkSirensStat> (Finke+2021).
#             
...
__all__ = ['GLADE_v2', 'GLADEPlus_v2']



class GLADE_v2(GalCat):
    ...
    def load(self, band             = None,
        ...
        if not loaded:
            ...
            if get_cosmo_z:
                ...
                dL_grid = fLCDM.dL(z_grid, chimeraUtils.lambda_cosmo_GLADE)                
        ...
        if add_B_lum:
            ...
            my_dist                 = fLCDM.dL(df.z.values, chimeraUtils.lambda_cosmo_GLADE)     
